...
class ParkMap extends Component {
  ...
  showParks = (parks) => {
    ...
    const greenIcon = new L.icon({ ...icon, iconUrl: './assets/green-icon.png'});
    const violetIcon = new L.icon({ ...icon, iconUrl: './assets/purple-icon.png'});
    const blueIcon = new L.icon({ ...icon, iconUrl: './assets/red-icon.png'});
